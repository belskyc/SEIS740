...
extern void SSPWriteSingleByte( uint32_t portnum, uint8_t *buf, uint32_t Length );
extern void SSPReceive( uint32_t portnum, uint8_t *buf, uint32_t Length );
extern void SSPReceiveSingleByte( uint32_t portnum, uint8_t *wbuf, uint8_t *rbuf);
extern void SSPMultByteRead( uint32_t portnum, uint8_t *buf);
extern void SSP1InitADXL345( void );
