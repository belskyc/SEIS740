...
uint8_t UART_IRQ_errors[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
uint32_t IR_LANE1_ID = IR_ID_1_1;
uint32_t IR_LANE2_ID = IR_ID_2_1;
...
void EINT3_IRQHandler(void)
{
	...
	if (nQStatus != pdPASS)
	{
		UART_IRQ_errors[IR_LANE1_ID] = 1;
	}

	// printf("EINT3_IRQHandler(): IR_IRQ_errors[%d] = %d\n", IR_LANE1_ID, IR_IRQ_errors[IR_LANE1_ID]);
	// printf("EINT3_IRQHandler(): UART_IRQ_errors[%d] = %d\n", IR_LANE1_ID, UART_IRQ_errors[IR_LANE1_ID]);
